...
export default function InsideApp() {
  ...
  <NavigationContainer>
    ...
    >
      <BottomTab.Screen name="HotTabNav" component={HotTabNav}
      options={{
        tabBarColor: '#009387',
      ...
      <BottomTab.Screen name="MyProfileNav" component={MyProfileNav}
        options={({ route }) => ({
            tabBarIcon: ({ color, size, focused, style }) => (
              <View style={styles.iconView}>
                <Icons2 name="user-alt" color={focused ? colors.brandColor : unfocused}
                  size={focused ? scale(30) : size}
                  style={focused ? styles.iconFocused : styles.iconUnFocused}
      ...
      <BottomTab.Screen name="SentRequest" component={SentRequestNav} 
        options={({ route }) => ({
            tabBarIcon: ({ color, size, focused, style }) => (
              <View style={styles.iconView}>
      ...
      />
      <BottomTab.Screen name="MyRequest" component={MyRequestNav} 
        options={{
            tabBarIcon: ({ color, size, focused, style }) => (
              <View style={styles.iconView}>
                <Icons2 name="grin-hearts"
