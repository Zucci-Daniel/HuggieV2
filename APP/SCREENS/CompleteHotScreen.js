    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.ViewIcon}>
                <DateButton extraStyle={styles.centerIcon} evelopeSize={200} heartSize={150} />
            </View>
            <ScrollView
            ...
            >
                ...
                <Screen innerRef={middle} extraStyles={styles.screenStyle} >
                    <ProfileDisplay extraStyles={styles.ProfileDisplayExtra} image={image} username={username} dept={dept} level={level}>{children}</ProfileDisplay>
                </Screen>
                <HotDetails>
